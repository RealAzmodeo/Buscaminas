...
export const FIXED_FURY_ABILITIES_POOL: Record<string, FuryAbility> = {
  fury_muro_fortify: {
    id: "fury_muro_fortify",
    name: "Fortificar Baluarte",
    description: "El Muro gana <strong>10 Armadura</strong>.",
    icon: "🧱🛡️",
    effectType: FuryAbilityEffectType.EnemyGainArmor,
    value: 10,
    rarity: Rarity.Rare,
  },
  fury_enjambre_overwhelm: {
    id: "fury_enjambre_overwhelm",
    name: "Oleada Incesante",
    description: "Añade <strong>3 Casillas de Ataque</strong> al tablero.",
    icon: "💨⚔️",
    effectType: FuryAbilityEffectType.BoardAddAttacks,
    value: 3,
    rarity: Rarity.Rare,
  },
  fury_ilusionista_deceive: {
    id: "fury_ilusionista_deceive",
    name: "Velo de Engaño",
    description:
      "<strong>Todas las pistas</strong> se ocultan temporalmente por <strong>3 clics</strong>.",
    icon: "❓🎭",
    effectType: FuryAbilityEffectType.BoardObscureAllClues,
    value: { durationClicks: 3 },
    rarity: Rarity.Epic,
  },
  fury_verdugo_execute: {
    id: "fury_verdugo_execute",
    name: "Golpe de Gracia",
    description:
      "Inflige <strong>30% del HP MÁXIMO</strong> del jugador como daño.",
    icon: "💀🎯",
  ...
  fury_parasito_leech: {
    id: "fury_parasito_leech",
    name: "Drenaje Vital",
    description:
      "El jugador pierde <strong>3 Oro</strong> y el Parásito recupera <strong>5 HP</strong>.",
    icon: "🦠💸",
    effectType: FuryAbilityEffectType.PlayerGoldLossAndEnemyHeal,
    value: { goldLoss: 3, enemyHeal: 5 },
    rarity: Rarity.Rare,
  },
};

export const DOMAIN_ABILITIES_POOL: Record<string, DomainAbilityDefinition> = {
  domain_muro_steadfast: {
    id: "domain_muro_steadfast",
    name: "Baluarte Inamovible",
    description:
      "Pasiva: El Muro no puede tener su Furia reducida por efectos de Ecos.",
  },
  domain_ilusionista_mirrorImage: {
    id: "domain_ilusionista_mirrorImage",
    name: "Reflejos Fugaces",
    description:
      "Pasiva: Al recibir daño, 20% de probabilidad de ignorarlo y ocultar 2 pistas aleatorias.",
  },
  domain_verdugo_berserk: {
    id: "domain_verdugo_berserk",
    name: "Frenesí Sangriento",
    description:
      "Pasiva: Cuando su HP está por debajo del 50%, su Furia se carga un 25% más rápido.",
  },
};
...
const FLOOR_2_ENCOUNTERS: FloorEncounterConfig[] = [
  ...
  {
    archetypeId: EnemyArchetypeId.Ilusionista,
    rank: EnemyRank.Minion,
    weight: 15,
  },
  {
